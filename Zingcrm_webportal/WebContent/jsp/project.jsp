...
<body onpageshow="if (event.persisted) noBack();" onbeforeunload="" onLoad="noBack();">
				...
				<div class="filter">
					...
					<div id="allOpp" class="hideall">
						<form class="contentsearch" name='search' action="" method='POST'>
							...
							<div class="infodashboard">
								...
								<div class="pageimg">
									<ul>
										<li class="infotitlehead">Project</li>
										<li>Projects from your Prospects and Customers</li>
									</ul>
								</div>
							</div>
						...
						<form:form name="leadfrm" id="newOppfrm" style="display: inline;"
							...
							<div class="mainDiv">
								...
								<div class="oppWid">
									...
									<p class="continput">
											<%-- <form:input path="expectedValue" type="text" resize="none"
												...
												class="fieldinputac"></form:input> --%>
												<form:select path="expectedValue" type="text" id="newExpectedValue"
												name="newExpectedValue" maxlength="50" class="fieldinputac"
												>
												<option value=0>Select</option>
											</form:select>
										</p>
									...
									<div class="headleft">
										<p class="contlbl">
											Competitor Info:<font color="red"></font>
										</p>
										<p class="continput">
										<form:input path="competitorquote" type="text" resize="none"
												id="newCompetitorquote" name="newCompetitorquote" maxlength="50"
												class="fieldinputac"></form:input>
									<!-- 	<p id="newCompetitorquoteError" class="errorMsg hideall">This
											information is required
										<p>
										<p id="newCompetitorquoteValidError" class="errorMsg hideall">This
											information is numeric
										<p> -->
										</p>
									</div>
									<div class="headleft">
										...
										<p class="continput">
											<form:textarea path="description" type="text" resize="none"
												id="newOppDesc" name="newOppDesc" maxlength="5000"
								...
								<div class="creOppCanBtn">
								 <p>
										<input type="button" value="Create Activity" class="signupbutton"
											id="newcreateActivity" />
									</p> 
									<p>
									...
									<p>
										<input type="button" value="Go Back" class="cancelbutton"
											id="cancelOpp" />
									</p>
								</div>
						...
						<form:form name="editOppfrm" id="editOppfrm"
							...
							<div class="mainDiv">
									...
									<div class="headrightExp">
										<!-- <p class="contlbl">
											...
											<%-- <form:input path="expectedValue" type="text" resize="none"
												...
												class="fieldinputac"></form:input> --%>
												<form:select path="expectedValue" type="text" id="editExpectedValue"
												name="editExpectedValue" maxlength="50" class="fieldinputac"
												>
												<option value=0>Select</option>
											</form:select>
										</p>
								...
								<!-- 	<div class="spacebtn"></div> -->
									...
									<p class="contlbl">Status</p>
									<p class="continput">
										<select  type="text" resize="none"	id="editOppStatus" 	class="fieldinputac"></select>
									</p>
									</div> -->
									<div class="headright">
										<p class="contlbl">
									...
									<div class="headleft">
										...
										<p class="continput">
										<form:input path="competitorquote" type="text" resize="none"
												id="editCompetitorquote" name="editCompetitorquote" maxlength="50"
												class="fieldinputac"></form:input>
									...
									<p class="continput">
										<form:textarea path="description" type="text" resize="none"
											id="editOppDesc" name="editOppDesc" maxlength="5000"
											class="fieldinputac"></form:textarea>
								...
								<input type="hidden" id="editleadid" name="editleadid"></input>
								<div class="clrdiv"></div>
					...
					<form id="frmOppAct" action="/activity" hidden="true" method="post">
						<input type="hidden" id="oppoppleadId" name="oppId" /> <input
							type="hidden" id="oppleadId" name="leadId" /> 
							<input type="hidden" id="createAct" name="createAct" /><input
	...
	<form id="frmCreateAct" action="/activity" hidden="true"
			method="post">
			<input type="hidden" id="createActivity" name="createAct" />
			<input type="hidden" id="oppname" name="oppname" />
	...
	<div id="dlgsProjectSuccMsg" class="hideall"></div> 
	<div id="dlgsProjectEditSuccMsg" class="hideall"></div> 
	<script type="text/javascript"
	...
	<script type="text/javascript"
		src=<c:url value="/resources/js/project.js?t=1.5"/>></script>
	<p class="foot">
